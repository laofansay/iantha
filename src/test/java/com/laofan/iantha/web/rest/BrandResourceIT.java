...
import static com.laofan.iantha.domain.BrandAsserts.*;
...
class BrandResourceIT {
    ...
    public static Brand createEntity(EntityManager em) {
        Brand brand = new Brand().title(DEFAULT_TITLE).description(DEFAULT_DESCRIPTION).logo(DEFAULT_LOGO);
        return brand;
    }
    ...
    public static Brand createUpdatedEntity(EntityManager em) {
        Brand brand = new Brand().title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).logo(UPDATED_LOGO);
        return brand;
    }
    ...
    void putExistingBrand() throws Exception {
        ...
        updatedBrand.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).logo(UPDATED_LOGO);
    ...
    void partialUpdateBrandWithPatch() throws Exception {
        ...
        partialUpdatedBrand.description(UPDATED_DESCRIPTION).logo(UPDATED_LOGO);
    ...
    void fullUpdateBrandWithPatch() throws Exception {
        ...
        partialUpdatedBrand.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).logo(UPDATED_LOGO);
