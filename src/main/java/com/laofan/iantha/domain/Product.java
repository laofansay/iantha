...
public class Product implements Serializable {
    ...
    public void setBrands(Set<Brand> brands) {
        if (this.brands != null) {
            this.brands.forEach(i -> i.setProducts(null));
        }
        if (brands != null) {
            brands.forEach(i -> i.setProducts(this));
        }
        this.brands = brands;
    }

    public Product brands(Set<Brand> brands) {
    ...
    public Product removeBrand(Brand brand) {
    ...
    public void setCategories(Set<Category> categories) {
        if (this.categories != null) {
            this.categories.forEach(i -> i.setProducts(null));
        }
        if (categories != null) {
            categories.forEach(i -> i.setProducts(this));
        }
