...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './payment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PAYMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PAYMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PAYMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PAYMENT actions', async () => {
      const arg = 42666;
