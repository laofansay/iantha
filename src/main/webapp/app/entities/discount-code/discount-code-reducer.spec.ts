...
describe('Entities reducer tests', () => {
  ...
  const initialState: EntityState<IDiscountCode> = {
    loading: false,
    errorMessage: null,
    entities: [],
    entity: defaultValue,
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISCOUNTCODE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DISCOUNTCODE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DISCOUNTCODE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DISCOUNTCODE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DISCOUNTCODE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DISCOUNTCODE actions', async () => {
      const arg = 42666;
