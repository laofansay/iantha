...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './cart.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CART_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CART actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CART actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CART actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CART actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CART actions', async () => {
      const arg = 42666;
