...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './refund.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REFUND_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REFUND actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REFUND actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_REFUND actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_REFUND actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REFUND actions', async () => {
      const arg = 42666;
