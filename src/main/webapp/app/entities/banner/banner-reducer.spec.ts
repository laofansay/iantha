...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './banner.reducer';
...
describe('Entities reducer tests', () => {
  ...
  const initialState: EntityState<IBanner> = {
    loading: false,
    errorMessage: null,
    entities: [],
    entity: defaultValue,
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANNER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BANNER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BANNER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BANNER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BANNER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BANNER actions', async () => {
      const arg = 42666;
