...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BABYLABEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BABYLABEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BABYLABEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BABYLABEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BABYLABEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BABYLABEL actions', async () => {
      const arg = 42666;
