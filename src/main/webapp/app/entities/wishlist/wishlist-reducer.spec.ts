...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './wishlist.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WISHLIST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WISHLIST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WISHLIST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WISHLIST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WISHLIST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WISHLIST actions', async () => {
      const arg = 42666;
