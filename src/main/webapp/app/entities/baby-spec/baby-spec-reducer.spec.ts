...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './baby-spec.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BABYSPEC_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BABYSPEC actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BABYSPEC actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BABYSPEC actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BABYSPEC actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BABYSPEC actions', async () => {
      const arg = 42666;
