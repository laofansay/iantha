...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENTPROVIDER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PAYMENTPROVIDER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PAYMENTPROVIDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PAYMENTPROVIDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENTPROVIDER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PAYMENTPROVIDER actions', async () => {
      const arg = 42666;
